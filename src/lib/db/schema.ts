...
export const uploads = pgTable(
  ...
  table => ({
    userUploadTypeIdx: index('uploads_user_type_idx').on(
      table.userId,
      table.uploadType
    ),
...
export const networks = pgTable(
  ...
  table => ({
    uploadBssidUnique: unique('networks_upload_bssid_unique').on(
      table.uploadId,
      table.bssid
    ),
...
export const accounts = pgTable(
  ...
  table => ({
    ...
    accountIdx: unique('accounts_account_idx').on(
      table.accountId,
      table.providerId
    ),
  })
...
export const crackedPasswords = pgTable(
  'cracked_passwords',
  {
    id: uuid('id').primaryKey().defaultRandom(),
...
export const crackedPasswordsRelations = relations(
  crackedPasswords,
  ({ one }) => ({
    job: one(jobs, {
