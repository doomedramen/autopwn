...
import { UploadProgressProps, UploadItem, formatFileSize, formatSpeed, formatDuration } from './types';
...
export function UploadProgress({
  ...
  return (
    <div className={cn('border rounded-lg p-4 space-y-3', className)}>
      ...
      {progress.stage !== 'completed' && progress.stage !== 'error' && (
        <div className="space-y-1">
          <div className="w-full bg-gray-200 rounded-full h-2">
            <div
              className={cn('h-2 rounded-full transition-all duration-300', getProgressBarColor(progress.stage))}
      ...
      {showDetails && (progress.stage === 'uploading' || progress.stage === 'processing') && (
